    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('custom.edit_country') }}</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">{{ __('custom.edit_country') }}</h4>
                <form class="form-validate" action="{{ route('admin.countries.update', $country->id) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" name="shortname" class="form-control" value="{{ old('shortname', $country->shortname) }}" required>
                            @error('shortname')
                            <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" name="phonecode" class="form-control" value="{{ old('phonecode', $country->phonecode) }}" required>
                            @error('phonecode')
                            <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
